...
- **🔒 本地優先 (Local-First)**: 你的個人空間（General Space）資料完全存儲於手機本地，不經過任何雲端伺服器。
- **🛡️ E2E 加密社群**: 所有的共享空間均採用端對端加密技術，只有空間內的成員能解鎖內容。
- **📁 層級式資料夾 (Spaces)**: 首創階層式的討論空間，讓你像整理電腦資料夾一樣井然有序地管理你的討論。
- **🚫 拒絕社交焦慮**: 我們廢除了「按讚」功能，讓社交回歸單純的文字討論與思緒交流。
- **💎 精品美學**: 全介面採用深色模式（Night Mode）與毛玻璃質感（Glassmorphism）設計。

---

## 🚀 即將上線

- **Google Play 商店**: 預計 2026 年 7 月 - 8 月正式上線。
- **Beta 測試**: 現在可以透過 GitHub Releases 下載 APK 搶先體驗。
...
- **Framework**: [Flutter](https://flutter.dev)
- **Database**: [Hive](https://pub.dev/packages/hive) (高性能本地存儲)
...
1. 前往本專案的 [Releases](https://github.com/01min/01min.github.io/releases) 頁面。
2. 下載最新的 `mono.apk` 檔案。
3. 在你的 Android 手機上點擊安裝即可。

---

## 🌐 官方網站

拜訪我們的專屬行銷網站：[01min.github.io](https://01min.github.io)

---

© 2026 Mono Project. Built with Privacy by Design.
=======
...
>>>>>>> 03fd318986bc23d82857f518913892f3ab8887a5
